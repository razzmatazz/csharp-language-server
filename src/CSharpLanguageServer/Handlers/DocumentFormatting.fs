...
module DocumentFormatting =
    ...
    let handle
            ...
            (p: DocumentFormattingParams) : AsyncLspResult<TextEdit[] option> = async {
        ...
        match doc with
        | Some doc ->
            let! textEdits = doc |> formatDocument  lspFormattingOptions
            return textEdits |> LspResult.success
        | None ->
