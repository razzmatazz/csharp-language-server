...
module Mappings =
    ...
    let routeMappings () =
        ...
        [
            ...
            serverRequestHandling (fun server request -> server.TypeHierarchySubtypes(request))
            "textDocument/inlineValue",
            serverRequestHandling (fun server request -> server.TextDocumentInlineValue(request))
            "textDocument/inlayHint",
            serverRequestHandling (fun server request -> server.TextDocumentInlayHint(request))
            ...
            serverRequestHandling (fun server request -> server.CompletionItemResolve(request))
